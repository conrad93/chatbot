    ...
    <div className="h-screen bg-gray-700 py-4">
      ...
      <div className="fixed bottom-0 left-0 z-50 w-full py-2 px-8">
        <div className="relative shadow">
          <input type="text" className="block w-full p-4 pl-10 text-sm text-white focus:outline-none rounded-lg bg-gray-600"/>
          <button type="button" className="text-white absolute right-2.5 bottom-2.5 bg-gray-700 focus:outline-none hover:bg-gray-500 font-medium rounded-lg text-sm px-4 py-2">Submit</button>
        </div>
      </div>
